            ...
            namespace connection {
                ...
                namespace v1 {
                    ...
                    class CloudResourceProperties implements ICloudResourceProperties {
                        ...
                        /**
                         * Creates a CloudResourceProperties message from a plain object. Also converts values to their respective internal types.
                         * @param object Plain object
                         * @returns CloudResourceProperties
                         */
                        public static fromObject(object: { [k: string]: any }): google.cloud.bigquery.connection.v1.CloudResourceProperties;

                        /**
                         * Creates a plain object from a CloudResourceProperties message. Also converts values to other types if specified.
                         * @param message CloudResourceProperties
                         * @param [options] Conversion options
                         * @returns Plain object
                         */
                        public static toObject(message: google.cloud.bigquery.connection.v1.CloudResourceProperties, options?: $protobuf.IConversionOptions): { [k: string]: any };

                        /**
                         * Converts this CloudResourceProperties to JSON.
                         * @returns JSON object
                         */
                        public toJSON(): { [k: string]: any };
