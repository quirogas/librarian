...
export class FunctionServiceClient {
  ...
  constructor(
    ...
    if (opts.fallback) {
      ...
      lroOptions.httpRules = [
        ...
        },
        {
          ...
          get: '/v2alpha/{resource=projects/*/locations/*/functions/*}:getIamPolicy',
        },
        {
          selector: 'google.iam.v1.IAMPolicy.SetIamPolicy',
          post: '/v2alpha/{resource=projects/*/locations/*/functions/*}:setIamPolicy',
          body: '*',
        },
        {
          selector: 'google.iam.v1.IAMPolicy.TestIamPermissions',
          post: '/v2alpha/{resource=projects/*/locations/*/functions/*}:testIamPermissions',
          body: '*',
        },
        {
    ...
    const createFunctionMetadata = protoFilesRoot.lookup(
      '.google.cloud.functions.v2alpha.OperationMetadata',
    ) as gax.protobuf.Type;
  ...
  getFunction(
    ...
    callback: Callback<
      protos.google.cloud.functions.v2alpha.IFunction,
      | protos.google.cloud.functions.v2alpha.IGetFunctionRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  listRuntimes(
    ...
    callback: Callback<
      protos.google.cloud.functions.v2alpha.IListRuntimesResponse,
      | protos.google.cloud.functions.v2alpha.IListRuntimesRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  async checkCreateFunctionProgress(
    ...
    LROperation<
      protos.google.cloud.functions.v2alpha.Function,
      protos.google.cloud.functions.v2alpha.OperationMetadata
    >
  > {
