...
export class SqlInstancesServiceClient {
   ...
   */
  addServerCertificate(
    request?: protos.google.cloud.sql.v1.ISqlInstancesAddServerCertificateRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1.IOperation,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesAddServerCertificateRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('addServerCertificate response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .addServerCertificate(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IOperation,
          (
   ...
   */
  addEntraIdCertificate(
    request?: protos.google.cloud.sql.v1.ISqlInstancesAddEntraIdCertificateRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1.IOperation,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesAddEntraIdCertificateRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('addEntraIdCertificate response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .addEntraIdCertificate(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IOperation,
          (
   ...
   */
  listServerCertificates(
    request?: protos.google.cloud.sql.v1.ISqlInstancesListServerCertificatesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1.IInstancesListServerCertificatesResponse,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesListServerCertificatesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('listServerCertificates response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .listServerCertificates(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IInstancesListServerCertificatesResponse,
          (
   ...
   */
  listEntraIdCertificates(
    request?: protos.google.cloud.sql.v1.ISqlInstancesListEntraIdCertificatesRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1.IInstancesListEntraIdCertificatesResponse,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesListEntraIdCertificatesRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('listEntraIdCertificates response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .listEntraIdCertificates(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IInstancesListEntraIdCertificatesResponse,
          (
   ...
   */
  rotateServerCertificate(
    request?: protos.google.cloud.sql.v1.ISqlInstancesRotateServerCertificateRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1.IOperation,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesRotateServerCertificateRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('rotateServerCertificate response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .rotateServerCertificate(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IOperation,
          (
   ...
   */
  rotateEntraIdCertificate(
    request?: protos.google.cloud.sql.v1.ISqlInstancesRotateEntraIdCertificateRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1.IOperation,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesRotateEntraIdCertificateRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('rotateEntraIdCertificate response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .rotateEntraIdCertificate(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IOperation,
          (
   ...
   */
  executeSql(
    request?: protos.google.cloud.sql.v1.ISqlInstancesExecuteSqlRequest,
    options?: CallOptions,
  ): Promise<
    [
  ...
  executeSql(
    ...
    callback: Callback<
      protos.google.cloud.sql.v1.ISqlInstancesExecuteSqlResponse,
      | protos.google.cloud.sql.v1.ISqlInstancesExecuteSqlRequest
      | null
      | undefined,
      {} | null | undefined
    >,
  ...
  preCheckMajorVersionUpgrade(
    ...
    [
      protos.google.cloud.sql.v1.IOperation,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesPreCheckMajorVersionUpgradeRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('preCheckMajorVersionUpgrade response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .preCheckMajorVersionUpgrade(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IOperation,
          (
   ...
   */
  pointInTimeRestore(
    request?: protos.google.cloud.sql.v1.ISqlInstancesPointInTimeRestoreRequest,
    options?: CallOptions,
  ): Promise<
    [
      protos.google.cloud.sql.v1.IOperation,
      (
        | protos.google.cloud.sql.v1.ISqlInstancesPointInTimeRestoreRequest
        | undefined
      ),
      {} | undefined,
    ]
  ...
  > | void {
    ...
    const wrappedCallback:
      ...
      | undefined = callback
      ? (error, response, options, rawResponse) => {
          this._log.info('pointInTimeRestore response %j', response);
          callback!(error, response, options, rawResponse); // We verified callback above.
        }
      : undefined;
    return this.innerApiCalls
      .pointInTimeRestore(request, options, wrappedCallback)
      ?.then(
        ([response, options, rawResponse]: [
          protos.google.cloud.sql.v1.IOperation,
          (
