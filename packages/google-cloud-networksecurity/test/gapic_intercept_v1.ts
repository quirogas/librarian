...
describe('v1.InterceptClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath = interceptModule.v1.InterceptClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint = interceptModule.v1.InterceptClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'networksecurity.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new interceptModule.v1.InterceptClient({
          universe_domain: 'example.com',
    ...
    it('has port', () => {
      const port = interceptModule.v1.InterceptClient.port;
      assert(port);
  ...
  describe('getInterceptEndpointGroup', () => {
    it('invokes getInterceptEndpointGroup without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetInterceptEndpointGroupRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.InterceptEndpointGroup(),
      );
      client.innerApiCalls.getInterceptEndpointGroup =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getInterceptEndpointGroup(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getInterceptEndpointGroup as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getInterceptEndpointGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptEndpointGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IInterceptEndpointGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInterceptEndpointGroup with error', async () => {
      ...
      client.innerApiCalls.getInterceptEndpointGroup = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getInterceptEndpointGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getInterceptEndpointGroup as SinonStub
  ...
  describe('getInterceptEndpointGroupAssociation', () => {
    it('invokes getInterceptEndpointGroupAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetInterceptEndpointGroupAssociationRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.InterceptEndpointGroupAssociation(),
      );
      client.innerApiCalls.getInterceptEndpointGroupAssociation =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.getInterceptEndpointGroupAssociation(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getInterceptEndpointGroupAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getInterceptEndpointGroupAssociation as SinonStub
    ...
    it('invokes getInterceptEndpointGroupAssociation without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptEndpointGroupAssociation(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IInterceptEndpointGroupAssociation | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInterceptEndpointGroupAssociation with error', async () => {
      ...
      await assert.rejects(
        client.getInterceptEndpointGroupAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getInterceptEndpointGroupAssociation as SinonStub
  ...
  describe('getInterceptDeploymentGroup', () => {
    it('invokes getInterceptDeploymentGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetInterceptDeploymentGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.InterceptDeploymentGroup(),
      );
      client.innerApiCalls.getInterceptDeploymentGroup =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getInterceptDeploymentGroup(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getInterceptDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getInterceptDeploymentGroup as SinonStub
    ...
    it('invokes getInterceptDeploymentGroup without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptDeploymentGroup(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IInterceptDeploymentGroup | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInterceptDeploymentGroup with error', async () => {
      ...
      await assert.rejects(
        client.getInterceptDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getInterceptDeploymentGroup as SinonStub
  ...
  describe('getInterceptDeployment', () => {
    it('invokes getInterceptDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetInterceptDeploymentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.InterceptDeployment(),
      );
      client.innerApiCalls.getInterceptDeployment =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getInterceptDeployment(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getInterceptDeployment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getInterceptDeployment as SinonStub
    ...
    it('invokes getInterceptDeployment without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getInterceptDeployment(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IInterceptDeployment | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getInterceptDeployment with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getInterceptDeployment = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getInterceptDeployment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getInterceptDeployment as SinonStub
  ...
  describe('createInterceptEndpointGroup', () => {
    it('invokes createInterceptEndpointGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateInterceptEndpointGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createInterceptEndpointGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createInterceptEndpointGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createInterceptEndpointGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createInterceptEndpointGroup as SinonStub
    ...
    it('invokes createInterceptEndpointGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createInterceptEndpointGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createInterceptEndpointGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createInterceptEndpointGroup as SinonStub
    ...
    it('invokes checkCreateInterceptEndpointGroupProgress without error', async () => {
      ...
      const decodedOperation =
        await client.checkCreateInterceptEndpointGroupProgress(
  ...
  describe('updateInterceptEndpointGroup', () => {
    it('invokes updateInterceptEndpointGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateInterceptEndpointGroupRequest(),
      );
      request.interceptEndpointGroup ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networksecurity.v1.UpdateInterceptEndpointGroupRequest',
        ['interceptEndpointGroup', 'name'],
      );
      ...
      client.innerApiCalls.updateInterceptEndpointGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateInterceptEndpointGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateInterceptEndpointGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateInterceptEndpointGroup as SinonStub
    ...
    it('invokes updateInterceptEndpointGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `intercept_endpoint_group.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateInterceptEndpointGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateInterceptEndpointGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateInterceptEndpointGroup as SinonStub
    ...
    it('invokes checkUpdateInterceptEndpointGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateInterceptEndpointGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateInterceptEndpointGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateInterceptEndpointGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteInterceptEndpointGroup', () => {
    it('invokes deleteInterceptEndpointGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteInterceptEndpointGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteInterceptEndpointGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteInterceptEndpointGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteInterceptEndpointGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteInterceptEndpointGroup as SinonStub
    ...
    it('invokes deleteInterceptEndpointGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteInterceptEndpointGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteInterceptEndpointGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteInterceptEndpointGroup as SinonStub
    ...
    it('invokes checkDeleteInterceptEndpointGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteInterceptEndpointGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteInterceptEndpointGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteInterceptEndpointGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createInterceptEndpointGroupAssociation', () => {
    it('invokes createInterceptEndpointGroupAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateInterceptEndpointGroupAssociationRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createInterceptEndpointGroupAssociation =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.createInterceptEndpointGroupAssociation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .createInterceptEndpointGroupAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes createInterceptEndpointGroupAssociation with call error', async () => {
      ...
      await assert.rejects(
        client.createInterceptEndpointGroupAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes checkCreateInterceptEndpointGroupAssociationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateInterceptEndpointGroupAssociationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateInterceptEndpointGroupAssociationProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateInterceptEndpointGroupAssociationProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateInterceptEndpointGroupAssociation', () => {
    it('invokes updateInterceptEndpointGroupAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateInterceptEndpointGroupAssociationRequest(),
      );
      request.interceptEndpointGroupAssociation ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networksecurity.v1.UpdateInterceptEndpointGroupAssociationRequest',
        ['interceptEndpointGroupAssociation', 'name'],
      );
      ...
      client.innerApiCalls.updateInterceptEndpointGroupAssociation =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.updateInterceptEndpointGroupAssociation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .updateInterceptEndpointGroupAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes updateInterceptEndpointGroupAssociation with call error', async () => {
      ...
      client.innerApiCalls.updateInterceptEndpointGroupAssociation =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.updateInterceptEndpointGroupAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes checkUpdateInterceptEndpointGroupAssociationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateInterceptEndpointGroupAssociationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteInterceptEndpointGroupAssociation', () => {
    it('invokes deleteInterceptEndpointGroupAssociation without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteInterceptEndpointGroupAssociationRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteInterceptEndpointGroupAssociation =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.deleteInterceptEndpointGroupAssociation(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls
          .deleteInterceptEndpointGroupAssociation as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls
    ...
    it('invokes deleteInterceptEndpointGroupAssociation with call error', async () => {
      ...
      client.innerApiCalls.deleteInterceptEndpointGroupAssociation =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.deleteInterceptEndpointGroupAssociation(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls
    ...
    it('invokes checkDeleteInterceptEndpointGroupAssociationProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteInterceptEndpointGroupAssociationProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('createInterceptDeploymentGroup', () => {
    it('invokes createInterceptDeploymentGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateInterceptDeploymentGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createInterceptDeploymentGroup =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createInterceptDeploymentGroup(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createInterceptDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createInterceptDeploymentGroup as SinonStub
    ...
    it('invokes createInterceptDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createInterceptDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createInterceptDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createInterceptDeploymentGroup as SinonStub
    ...
    it('invokes checkCreateInterceptDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateInterceptDeploymentGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateInterceptDeploymentGroup', () => {
    it('invokes updateInterceptDeploymentGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateInterceptDeploymentGroupRequest(),
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateInterceptDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateInterceptDeploymentGroup as SinonStub
    ...
    it('invokes updateInterceptDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `intercept_deployment_group.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateInterceptDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateInterceptDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateInterceptDeploymentGroup as SinonStub
    ...
    it('invokes checkUpdateInterceptDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateInterceptDeploymentGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateInterceptDeploymentGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateInterceptDeploymentGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteInterceptDeploymentGroup', () => {
    it('invokes deleteInterceptDeploymentGroup without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteInterceptDeploymentGroupRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteInterceptDeploymentGroup as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteInterceptDeploymentGroup as SinonStub
    ...
    it('invokes deleteInterceptDeploymentGroup with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteInterceptDeploymentGroup = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteInterceptDeploymentGroup(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteInterceptDeploymentGroup as SinonStub
    ...
    it('invokes checkDeleteInterceptDeploymentGroupProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteInterceptDeploymentGroupProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteInterceptDeploymentGroupProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteInterceptDeploymentGroupProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createInterceptDeployment', () => {
    it('invokes createInterceptDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateInterceptDeploymentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createInterceptDeployment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createInterceptDeployment as SinonStub
    ...
    it('invokes createInterceptDeployment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createInterceptDeployment = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createInterceptDeployment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createInterceptDeployment as SinonStub
    ...
    it('invokes checkCreateInterceptDeploymentProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateInterceptDeploymentProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateInterceptDeployment', () => {
    it('invokes updateInterceptDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateInterceptDeploymentRequest(),
      );
      ...
      client.innerApiCalls.updateInterceptDeployment =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateInterceptDeployment(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateInterceptDeployment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateInterceptDeployment as SinonStub
    ...
    it('invokes updateInterceptDeployment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `intercept_deployment.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateInterceptDeployment = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateInterceptDeployment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateInterceptDeployment as SinonStub
    ...
    it('invokes checkUpdateInterceptDeploymentProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateInterceptDeploymentProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateInterceptDeploymentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateInterceptDeploymentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteInterceptDeployment', () => {
    it('invokes deleteInterceptDeployment without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteInterceptDeploymentRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteInterceptDeployment as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteInterceptDeployment as SinonStub
    ...
    it('invokes deleteInterceptDeployment with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteInterceptDeployment = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteInterceptDeployment(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteInterceptDeployment as SinonStub
    ...
    it('invokes checkDeleteInterceptDeploymentProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteInterceptDeploymentProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteInterceptDeploymentProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteInterceptDeploymentProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listInterceptEndpointGroups', () => {
    it('invokes listInterceptEndpointGroups without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListInterceptEndpointGroupsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listInterceptEndpointGroups =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listInterceptEndpointGroups(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listInterceptEndpointGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listInterceptEndpointGroups as SinonStub
    ...
    it('invokes listInterceptEndpointGroups with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listInterceptEndpointGroups = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listInterceptEndpointGroups(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listInterceptEndpointGroups as SinonStub
    ...
    it('invokes listInterceptEndpointGroupsStream without error', async () => {
      ...
      client.descriptors.page.listInterceptEndpointGroups.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listInterceptEndpointGroupsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.InterceptEndpointGroup[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.InterceptEndpointGroup,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listInterceptEndpointGroups
    ...
    it('uses async iteration with listInterceptEndpointGroups without error', async () => {
      ...
      client.descriptors.page.listInterceptEndpointGroups.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IInterceptEndpointGroup[] =
        [];
  ...
  describe('listInterceptEndpointGroupAssociations', () => {
    it('invokes listInterceptEndpointGroupAssociations without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListInterceptEndpointGroupAssociationsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listInterceptEndpointGroupAssociations =
        stubSimpleCall(expectedResponse);
      const [response] =
        await client.listInterceptEndpointGroupAssociations(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listInterceptEndpointGroupAssociations as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listInterceptEndpointGroupAssociations as SinonStub
    ...
    it('invokes listInterceptEndpointGroupAssociations with error', async () => {
      ...
      client.innerApiCalls.listInterceptEndpointGroupAssociations =
        stubSimpleCall(undefined, expectedError);
      await assert.rejects(
        client.listInterceptEndpointGroupAssociations(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listInterceptEndpointGroupAssociations as SinonStub
    ...
    it('invokes listInterceptEndpointGroupAssociationsStream without error', async () => {
      ...
      client.descriptors.page.listInterceptEndpointGroupAssociations.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream =
        client.listInterceptEndpointGroupAssociationsStream(request);
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.InterceptEndpointGroupAssociation,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('uses async iteration with listInterceptEndpointGroupAssociations without error', async () => {
      ...
      client.descriptors.page.listInterceptEndpointGroupAssociations.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IInterceptEndpointGroupAssociation[] =
        [];
      const iterable =
        client.listInterceptEndpointGroupAssociationsAsync(request);
      for await (const resource of iterable) {
        responses.push(resource!);
      }
      assert.deepStrictEqual(responses, expectedResponse);
  ...
  describe('listInterceptDeploymentGroups', () => {
    it('invokes listInterceptDeploymentGroups without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListInterceptDeploymentGroupsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listInterceptDeploymentGroups =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listInterceptDeploymentGroups(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listInterceptDeploymentGroups as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listInterceptDeploymentGroups as SinonStub
    ...
    it('invokes listInterceptDeploymentGroupsStream without error', async () => {
      ...
      client.descriptors.page.listInterceptDeploymentGroups.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.InterceptDeploymentGroup,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listInterceptDeploymentGroups
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listInterceptDeploymentGroups without error', async () => {
      ...
      client.descriptors.page.listInterceptDeploymentGroups.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IInterceptDeploymentGroup[] =
        [];
  ...
  describe('listInterceptDeployments', () => {
    it('invokes listInterceptDeployments without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListInterceptDeploymentsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listInterceptDeployments =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listInterceptDeployments(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listInterceptDeployments as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listInterceptDeployments as SinonStub
    ...
    it('invokes listInterceptDeployments with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listInterceptDeployments = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listInterceptDeployments(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listInterceptDeployments as SinonStub
    ...
    it('invokes listInterceptDeploymentsStream without error', async () => {
      ...
      client.descriptors.page.listInterceptDeployments.createStream =
        stubPageStreamingCall(expectedResponse);
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.InterceptDeployment,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listInterceptDeployments
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listInterceptDeployments, request),
      );
      assert(
        (
          client.descriptors.page.listInterceptDeployments
    ...
    it('uses async iteration with listInterceptDeployments without error', async () => {
      ...
      client.descriptors.page.listInterceptDeployments.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IInterceptDeployment[] =
        [];
