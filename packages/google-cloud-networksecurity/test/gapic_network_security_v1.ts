...
describe('v1.NetworkSecurityClient', () => {
  ...
  describe('getBackendAuthenticationConfig', () => {
    it('invokes getBackendAuthenticationConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetBackendAuthenticationConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.BackendAuthenticationConfig(),
      );
      client.innerApiCalls.getBackendAuthenticationConfig =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getBackendAuthenticationConfig(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getBackendAuthenticationConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getBackendAuthenticationConfig as SinonStub
    ...
    it('invokes getBackendAuthenticationConfig without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getBackendAuthenticationConfig(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IBackendAuthenticationConfig | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getBackendAuthenticationConfig with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getBackendAuthenticationConfig = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getBackendAuthenticationConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getBackendAuthenticationConfig as SinonStub
  ...
  describe('getGatewaySecurityPolicy', () => {
    it('invokes getGatewaySecurityPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetGatewaySecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicy(),
      );
      client.innerApiCalls.getGatewaySecurityPolicy =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getGatewaySecurityPolicy(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGatewaySecurityPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGatewaySecurityPolicy as SinonStub
    ...
    it('invokes getGatewaySecurityPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGatewaySecurityPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGatewaySecurityPolicy with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getGatewaySecurityPolicy = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getGatewaySecurityPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getGatewaySecurityPolicy as SinonStub
  ...
  describe('getGatewaySecurityPolicyRule', () => {
    it('invokes getGatewaySecurityPolicyRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetGatewaySecurityPolicyRuleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GatewaySecurityPolicyRule(),
      );
      client.innerApiCalls.getGatewaySecurityPolicyRule =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getGatewaySecurityPolicyRule(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getGatewaySecurityPolicyRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getGatewaySecurityPolicyRule as SinonStub
    ...
    it('invokes getGatewaySecurityPolicyRule without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getGatewaySecurityPolicyRule(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicyRule | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getGatewaySecurityPolicyRule with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getGatewaySecurityPolicyRule = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getGatewaySecurityPolicyRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getGatewaySecurityPolicyRule as SinonStub
  ...
  describe('getUrlList', () => {
    it('invokes getUrlList without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetUrlListRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getUrlList without error using callback', async () => {
      ...
      client.innerApiCalls.getUrlList =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getUrlList(
          request,
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IUrlList | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getUrlList with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getUrlList = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('getTlsInspectionPolicy', () => {
    it('invokes getTlsInspectionPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetTlsInspectionPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.TlsInspectionPolicy(),
      );
      client.innerApiCalls.getTlsInspectionPolicy =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getTlsInspectionPolicy(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getTlsInspectionPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.getTlsInspectionPolicy as SinonStub
    ...
    it('invokes getTlsInspectionPolicy without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getTlsInspectionPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.ITlsInspectionPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getTlsInspectionPolicy with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getTlsInspectionPolicy = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.getTlsInspectionPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.getTlsInspectionPolicy as SinonStub
  ...
  describe('getAuthzPolicy', () => {
    it('invokes getAuthzPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetAuthzPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
    ...
    it('invokes getAuthzPolicy without error using callback', async () => {
      ...
      client.innerApiCalls.getAuthzPolicy =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.getAuthzPolicy(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IAuthzPolicy | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getAuthzPolicy with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.getAuthzPolicy = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createBackendAuthenticationConfig', () => {
    it('invokes createBackendAuthenticationConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateBackendAuthenticationConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createBackendAuthenticationConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.createBackendAuthenticationConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createBackendAuthenticationConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createBackendAuthenticationConfig as SinonStub
    ...
    it('invokes createBackendAuthenticationConfig with call error', async () => {
      ...
      await assert.rejects(
        client.createBackendAuthenticationConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createBackendAuthenticationConfig as SinonStub
    ...
    it('invokes checkCreateBackendAuthenticationConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateBackendAuthenticationConfigProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateBackendAuthenticationConfigProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateBackendAuthenticationConfigProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateBackendAuthenticationConfig', () => {
    it('invokes updateBackendAuthenticationConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateBackendAuthenticationConfigRequest(),
      );
      request.backendAuthenticationConfig ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networksecurity.v1.UpdateBackendAuthenticationConfigRequest',
        ['backendAuthenticationConfig', 'name'],
      );
      ...
      client.innerApiCalls.updateBackendAuthenticationConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.updateBackendAuthenticationConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateBackendAuthenticationConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateBackendAuthenticationConfig as SinonStub
    ...
    it('invokes updateBackendAuthenticationConfig with call error', async () => {
      ...
      client.innerApiCalls.updateBackendAuthenticationConfig =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.updateBackendAuthenticationConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateBackendAuthenticationConfig as SinonStub
    ...
    it('invokes checkUpdateBackendAuthenticationConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateBackendAuthenticationConfigProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteBackendAuthenticationConfig', () => {
    it('invokes deleteBackendAuthenticationConfig without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteBackendAuthenticationConfigRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteBackendAuthenticationConfig =
        stubLongRunningCall(expectedResponse);
      const [operation] =
        await client.deleteBackendAuthenticationConfig(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteBackendAuthenticationConfig as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteBackendAuthenticationConfig as SinonStub
    ...
    it('invokes deleteBackendAuthenticationConfig with call error', async () => {
      ...
      client.innerApiCalls.deleteBackendAuthenticationConfig =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.deleteBackendAuthenticationConfig(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteBackendAuthenticationConfig as SinonStub
    ...
    it('invokes checkDeleteBackendAuthenticationConfigProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteBackendAuthenticationConfigProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('createGatewaySecurityPolicy', () => {
    it('invokes createGatewaySecurityPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateGatewaySecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGatewaySecurityPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGatewaySecurityPolicy as SinonStub
    ...
    it('invokes createGatewaySecurityPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createGatewaySecurityPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createGatewaySecurityPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createGatewaySecurityPolicy as SinonStub
    ...
    it('invokes checkCreateGatewaySecurityPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateGatewaySecurityPolicyProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkCreateGatewaySecurityPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateGatewaySecurityPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateGatewaySecurityPolicy', () => {
    it('invokes updateGatewaySecurityPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateGatewaySecurityPolicyRequest(),
      );
      ...
      client.innerApiCalls.updateGatewaySecurityPolicy =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateGatewaySecurityPolicy(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGatewaySecurityPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGatewaySecurityPolicy as SinonStub
    ...
    it('invokes updateGatewaySecurityPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `gateway_security_policy.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateGatewaySecurityPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateGatewaySecurityPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateGatewaySecurityPolicy as SinonStub
    ...
    it('invokes checkUpdateGatewaySecurityPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateGatewaySecurityPolicyProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateGatewaySecurityPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateGatewaySecurityPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteGatewaySecurityPolicy', () => {
    it('invokes deleteGatewaySecurityPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteGatewaySecurityPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGatewaySecurityPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGatewaySecurityPolicy as SinonStub
    ...
    it('invokes deleteGatewaySecurityPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteGatewaySecurityPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteGatewaySecurityPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteGatewaySecurityPolicy as SinonStub
    ...
    it('invokes checkDeleteGatewaySecurityPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteGatewaySecurityPolicyProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteGatewaySecurityPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteGatewaySecurityPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createGatewaySecurityPolicyRule', () => {
    it('invokes createGatewaySecurityPolicyRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateGatewaySecurityPolicyRuleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createGatewaySecurityPolicyRule =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createGatewaySecurityPolicyRule(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createGatewaySecurityPolicyRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createGatewaySecurityPolicyRule as SinonStub
    ...
    it('invokes createGatewaySecurityPolicyRule with call error', async () => {
      ...
      client.innerApiCalls.createGatewaySecurityPolicyRule =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.createGatewaySecurityPolicyRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createGatewaySecurityPolicyRule as SinonStub
    ...
    it('invokes checkCreateGatewaySecurityPolicyRuleProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateGatewaySecurityPolicyRuleProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateGatewaySecurityPolicyRule', () => {
    it('invokes updateGatewaySecurityPolicyRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateGatewaySecurityPolicyRuleRequest(),
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateGatewaySecurityPolicyRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateGatewaySecurityPolicyRule as SinonStub
    ...
    it('invokes updateGatewaySecurityPolicyRule with call error', async () => {
      ...
      client.innerApiCalls.updateGatewaySecurityPolicyRule =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.updateGatewaySecurityPolicyRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateGatewaySecurityPolicyRule as SinonStub
    ...
    it('invokes checkUpdateGatewaySecurityPolicyRuleProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateGatewaySecurityPolicyRuleProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('deleteGatewaySecurityPolicyRule', () => {
    it('invokes deleteGatewaySecurityPolicyRule without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteGatewaySecurityPolicyRuleRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteGatewaySecurityPolicyRule =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteGatewaySecurityPolicyRule(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteGatewaySecurityPolicyRule as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteGatewaySecurityPolicyRule as SinonStub
    ...
    it('invokes deleteGatewaySecurityPolicyRule with call error', async () => {
      ...
      client.innerApiCalls.deleteGatewaySecurityPolicyRule =
        stubLongRunningCall(undefined, expectedError);
      await assert.rejects(
        client.deleteGatewaySecurityPolicyRule(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteGatewaySecurityPolicyRule as SinonStub
    ...
    it('invokes checkDeleteGatewaySecurityPolicyRuleProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteGatewaySecurityPolicyRuleProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteGatewaySecurityPolicyRuleProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteGatewaySecurityPolicyRuleProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createUrlList', () => {
    it('invokes createUrlList without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateUrlListRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createUrlList =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.createUrlList(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createUrlList as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createUrlList as SinonStub
    ...
    it('invokes createUrlList with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createUrlList = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateUrlListProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateUrlListProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateUrlList', () => {
    it('invokes updateUrlList without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateUrlListRequest(),
      );
      request.urlList ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.updateUrlList =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateUrlList(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateUrlList as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateUrlList as SinonStub
    ...
    it('invokes updateUrlList with call error', async () => {
      ...
      const expectedHeaderRequestParams = `url_list.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateUrlList = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateUrlListProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateUrlListProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteUrlList', () => {
    it('invokes deleteUrlList without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteUrlListRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteUrlList =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteUrlList(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteUrlList as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteUrlList as SinonStub
    ...
    it('invokes deleteUrlList with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteUrlList = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteUrlListProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteUrlListProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createTlsInspectionPolicy', () => {
    it('invokes createTlsInspectionPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateTlsInspectionPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createTlsInspectionPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createTlsInspectionPolicy as SinonStub
    ...
    it('invokes createTlsInspectionPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createTlsInspectionPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createTlsInspectionPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createTlsInspectionPolicy as SinonStub
    ...
    it('invokes checkCreateTlsInspectionPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkCreateTlsInspectionPolicyProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
  ...
  describe('updateTlsInspectionPolicy', () => {
    it('invokes updateTlsInspectionPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateTlsInspectionPolicyRequest(),
      );
      request.tlsInspectionPolicy ??= {};
      const defaultValue1 = getTypeDefaultValue(
        '.google.cloud.networksecurity.v1.UpdateTlsInspectionPolicyRequest',
        ['tlsInspectionPolicy', 'name'],
      );
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateTlsInspectionPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateTlsInspectionPolicy as SinonStub
    ...
    it('invokes updateTlsInspectionPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `tls_inspection_policy.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateTlsInspectionPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateTlsInspectionPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateTlsInspectionPolicy as SinonStub
    ...
    it('invokes checkUpdateTlsInspectionPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkUpdateTlsInspectionPolicyProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkUpdateTlsInspectionPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateTlsInspectionPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteTlsInspectionPolicy', () => {
    it('invokes deleteTlsInspectionPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteTlsInspectionPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteTlsInspectionPolicy =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteTlsInspectionPolicy(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteTlsInspectionPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteTlsInspectionPolicy as SinonStub
    ...
    it('invokes deleteTlsInspectionPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteTlsInspectionPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteTlsInspectionPolicy(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteTlsInspectionPolicy as SinonStub
    ...
    it('invokes checkDeleteTlsInspectionPolicyProgress without error', async () => {
      ...
      client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
      const decodedOperation =
        await client.checkDeleteTlsInspectionPolicyProgress(
          expectedResponse.name,
        );
      assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
      assert(decodedOperation.metadata);
    ...
    it('invokes checkDeleteTlsInspectionPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteTlsInspectionPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('createAuthzPolicy', () => {
    it('invokes createAuthzPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateAuthzPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createAuthzPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createAuthzPolicy as SinonStub
    ...
    it('invokes createAuthzPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createAuthzPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkCreateAuthzPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkCreateAuthzPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('updateAuthzPolicy', () => {
    it('invokes updateAuthzPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateAuthzPolicyRequest(),
      );
      request.authzPolicy ??= {};
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.updateAuthzPolicy =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.updateAuthzPolicy(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateAuthzPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateAuthzPolicy as SinonStub
    ...
    it('invokes updateAuthzPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `authz_policy.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateAuthzPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkUpdateAuthzPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkUpdateAuthzPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('deleteAuthzPolicy', () => {
    it('invokes deleteAuthzPolicy without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteAuthzPolicyRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteAuthzPolicy =
        stubLongRunningCall(expectedResponse);
      const [operation] = await client.deleteAuthzPolicy(request);
      const [response] = await operation.promise();
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteAuthzPolicy as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteAuthzPolicy as SinonStub
    ...
    it('invokes deleteAuthzPolicy with call error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteAuthzPolicy = stubLongRunningCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes checkDeleteAuthzPolicyProgress with error', async () => {
      ...
      await assert.rejects(
        client.checkDeleteAuthzPolicyProgress(''),
        expectedError,
      );
      assert((client.operationsClient.getOperation as SinonStub).getCall(0));
    });
  ...
  describe('listBackendAuthenticationConfigs', () => {
    it('invokes listBackendAuthenticationConfigs without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListBackendAuthenticationConfigsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listBackendAuthenticationConfigs =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listBackendAuthenticationConfigs(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listBackendAuthenticationConfigs as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listBackendAuthenticationConfigs as SinonStub
    ...
    it('invokes listBackendAuthenticationConfigs with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listBackendAuthenticationConfigs = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listBackendAuthenticationConfigs(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listBackendAuthenticationConfigs as SinonStub
    ...
    it('invokes listBackendAuthenticationConfigsStream without error', async () => {
      ...
      client.descriptors.page.listBackendAuthenticationConfigs.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listBackendAuthenticationConfigsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.BackendAuthenticationConfig[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.BackendAuthenticationConfig,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listBackendAuthenticationConfigs
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listBackendAuthenticationConfigs without error', async () => {
      ...
      client.descriptors.page.listBackendAuthenticationConfigs.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listGatewaySecurityPolicies', () => {
    it('invokes listGatewaySecurityPolicies without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListGatewaySecurityPoliciesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listGatewaySecurityPolicies =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listGatewaySecurityPolicies(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGatewaySecurityPolicies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGatewaySecurityPolicies as SinonStub
    ...
    it('invokes listGatewaySecurityPolicies with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGatewaySecurityPolicies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listGatewaySecurityPolicies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listGatewaySecurityPolicies as SinonStub
    ...
    it('invokes listGatewaySecurityPoliciesStream without error', async () => {
      ...
      client.descriptors.page.listGatewaySecurityPolicies.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listGatewaySecurityPoliciesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.GatewaySecurityPolicy[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.GatewaySecurityPolicy,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listGatewaySecurityPolicies
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(
    ...
    it('uses async iteration with listGatewaySecurityPolicies without error', async () => {
      ...
      client.descriptors.page.listGatewaySecurityPolicies.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicy[] =
        [];
  ...
  describe('listGatewaySecurityPolicyRules', () => {
    it('invokes listGatewaySecurityPolicyRules without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListGatewaySecurityPolicyRulesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listGatewaySecurityPolicyRules =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listGatewaySecurityPolicyRules(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listGatewaySecurityPolicyRules as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listGatewaySecurityPolicyRules as SinonStub
    ...
    it('invokes listGatewaySecurityPolicyRules with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listGatewaySecurityPolicyRules = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listGatewaySecurityPolicyRules(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listGatewaySecurityPolicyRules as SinonStub
    ...
    it('invokes listGatewaySecurityPolicyRulesStream without error', async () => {
      ...
      client.descriptors.page.listGatewaySecurityPolicyRules.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listGatewaySecurityPolicyRulesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.GatewaySecurityPolicyRule[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.GatewaySecurityPolicyRule,
          ) => {
            responses.push(response);
          },
        );
    ...
    it('uses async iteration with listGatewaySecurityPolicyRules without error', async () => {
      ...
      client.descriptors.page.listGatewaySecurityPolicyRules.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IGatewaySecurityPolicyRule[] =
        [];
  ...
  describe('listUrlLists', () => {
    it('invokes listUrlLists without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListUrlListsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listUrlLists as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listUrlLists as SinonStub
    ...
    it('invokes listUrlLists without error using callback', async () => {
      ...
      client.innerApiCalls.listUrlLists =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listUrlLists(
          request,
    ...
    it('invokes listUrlLists with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listUrlLists = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listUrlListsStream without error', async () => {
      ...
      client.descriptors.page.listUrlLists.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listUrlListsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.UrlList[] = [];
        stream.on(
          'data',
          (response: protos.google.cloud.networksecurity.v1.UrlList) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listUrlLists.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listUrlLists, request),
      );
      assert(
        (client.descriptors.page.listUrlLists.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listUrlListsStream with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.descriptors.page.listUrlLists.createStream = stubPageStreamingCall(
        undefined,
        expectedError,
      );
      const stream = client.listUrlListsStream(request);
    ...
    it('uses async iteration with listUrlLists without error', async () => {
      ...
      client.descriptors.page.listUrlLists.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IUrlList[] = [];
  ...
  describe('listTlsInspectionPolicies', () => {
    it('invokes listTlsInspectionPolicies without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListTlsInspectionPoliciesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listTlsInspectionPolicies =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listTlsInspectionPolicies(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listTlsInspectionPolicies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listTlsInspectionPolicies as SinonStub
    ...
    it('invokes listTlsInspectionPolicies with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listTlsInspectionPolicies = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listTlsInspectionPolicies(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listTlsInspectionPolicies as SinonStub
    ...
    it('invokes listTlsInspectionPoliciesStream without error', async () => {
      ...
      client.descriptors.page.listTlsInspectionPolicies.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listTlsInspectionPoliciesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.TlsInspectionPolicy[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.TlsInspectionPolicy,
          ) => {
            responses.push(response);
          },
        );
      ...
      assert(
        (
          client.descriptors.page.listTlsInspectionPolicies
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listTlsInspectionPolicies, request),
      );
      assert(
        (
          client.descriptors.page.listTlsInspectionPolicies
    ...
    it('uses async iteration with listTlsInspectionPolicies without error', async () => {
      ...
      client.descriptors.page.listTlsInspectionPolicies.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
  ...
  describe('listAuthzPolicies', () => {
    it('invokes listAuthzPolicies without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListAuthzPoliciesRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listAuthzPolicies as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listAuthzPolicies as SinonStub
    ...
    it('invokes listAuthzPolicies without error using callback', async () => {
      ...
      client.innerApiCalls.listAuthzPolicies =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listAuthzPolicies with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listAuthzPolicies = stubSimpleCall(
        undefined,
        expectedError,
      );
    ...
    it('invokes listAuthzPoliciesStream without error', async () => {
      ...
      client.descriptors.page.listAuthzPolicies.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listAuthzPoliciesStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.AuthzPolicy[] =
          [];
        stream.on(
          'data',
          (response: protos.google.cloud.networksecurity.v1.AuthzPolicy) => {
            responses.push(response);
          },
        );
        stream.on('end', () => {
      ...
      assert(
        (client.descriptors.page.listAuthzPolicies.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listAuthzPolicies, request),
      );
      assert(
        (client.descriptors.page.listAuthzPolicies.createStream as SinonStub)
          .getCall(0)
    ...
    it('uses async iteration with listAuthzPolicies without error', async () => {
      ...
      client.descriptors.page.listAuthzPolicies.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IAuthzPolicy[] =
        [];
