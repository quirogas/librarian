...
describe('v1.DnsThreatDetectorServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient
            .servicePath;
    ...
    it('has port', () => {
      const port =
        dnsthreatdetectorserviceModule.v1.DnsThreatDetectorServiceClient.port;
      assert(port);
  ...
  describe('getDnsThreatDetector', () => {
    it('invokes getDnsThreatDetector without error', async () => {
      ...
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.GetDnsThreatDetectorRequest(),
      );
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DnsThreatDetector(),
      );
      client.innerApiCalls.getDnsThreatDetector =
        stubSimpleCall(expectedResponse);
      const [response] = await client.getDnsThreatDetector(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.getDnsThreatDetector as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getDnsThreatDetector without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDnsThreatDetector(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.networksecurity.v1.IDnsThreatDetector | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getDnsThreatDetector with error', async () => {
      ...
      client.innerApiCalls.getDnsThreatDetector = stubSimpleCall(
        undefined,
        expectedError,
      );
  ...
  describe('createDnsThreatDetector', () => {
    it('invokes createDnsThreatDetector without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.CreateDnsThreatDetectorRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.createDnsThreatDetector =
        stubSimpleCall(expectedResponse);
      const [response] = await client.createDnsThreatDetector(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.createDnsThreatDetector as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.createDnsThreatDetector as SinonStub
    ...
    it('invokes createDnsThreatDetector with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.createDnsThreatDetector = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.createDnsThreatDetector(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.createDnsThreatDetector as SinonStub
  ...
  describe('updateDnsThreatDetector', () => {
    it('invokes updateDnsThreatDetector without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.UpdateDnsThreatDetectorRequest(),
      );
      ...
      client.innerApiCalls.updateDnsThreatDetector =
        stubSimpleCall(expectedResponse);
      const [response] = await client.updateDnsThreatDetector(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateDnsThreatDetector as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateDnsThreatDetector as SinonStub
    ...
    it('invokes updateDnsThreatDetector with error', async () => {
      ...
      const expectedHeaderRequestParams = `dns_threat_detector.name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.updateDnsThreatDetector = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.updateDnsThreatDetector(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.updateDnsThreatDetector as SinonStub
  ...
  describe('deleteDnsThreatDetector', () => {
    it('invokes deleteDnsThreatDetector without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.DeleteDnsThreatDetectorRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.deleteDnsThreatDetector =
        stubSimpleCall(expectedResponse);
      const [response] = await client.deleteDnsThreatDetector(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteDnsThreatDetector as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteDnsThreatDetector as SinonStub
    ...
    it('invokes deleteDnsThreatDetector with error', async () => {
      ...
      const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.deleteDnsThreatDetector = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.deleteDnsThreatDetector(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.deleteDnsThreatDetector as SinonStub
  ...
  describe('listDnsThreatDetectors', () => {
    it('invokes listDnsThreatDetectors without error', async () => {
      ...
      await client.initialize();
      const request = generateSampleMessage(
        new protos.google.cloud.networksecurity.v1.ListDnsThreatDetectorsRequest(),
      );
      const defaultValue1 = getTypeDefaultValue(
      ...
      client.innerApiCalls.listDnsThreatDetectors =
        stubSimpleCall(expectedResponse);
      const [response] = await client.listDnsThreatDetectors(request);
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listDnsThreatDetectors as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listDnsThreatDetectors as SinonStub
    ...
    it('invokes listDnsThreatDetectors with error', async () => {
      ...
      const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.listDnsThreatDetectors = stubSimpleCall(
        undefined,
        expectedError,
      );
      await assert.rejects(
        client.listDnsThreatDetectors(request),
        expectedError,
      );
      const actualRequest = (
        client.innerApiCalls.listDnsThreatDetectors as SinonStub
    ...
    it('invokes listDnsThreatDetectorsStream without error', async () => {
      ...
      client.descriptors.page.listDnsThreatDetectors.createStream =
        stubPageStreamingCall(expectedResponse);
      const stream = client.listDnsThreatDetectorsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.networksecurity.v1.DnsThreatDetector[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.networksecurity.v1.DnsThreatDetector,
          ) => {
      ...
      assert(
        (
          client.descriptors.page.listDnsThreatDetectors
            .createStream as SinonStub
        )
          .getCall(0)
          .calledWith(client.innerApiCalls.listDnsThreatDetectors, request),
      );
      assert(
        (
          client.descriptors.page.listDnsThreatDetectors
    ...
    it('uses async iteration with listDnsThreatDetectors without error', async () => {
      ...
      client.descriptors.page.listDnsThreatDetectors.asyncIterate =
        stubAsyncIterationCall(expectedResponse);
      const responses: protos.google.cloud.networksecurity.v1.IDnsThreatDetector[] =
        [];
