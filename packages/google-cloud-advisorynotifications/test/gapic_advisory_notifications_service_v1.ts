...
describe('v1.AdvisoryNotificationsServiceClient', () => {
  ...
  describe('getNotification', () => {
    it('invokes getNotification without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getNotification as SinonStub
      ).getCall(0).args[0];
    ...
    it('invokes getNotification without error using callback', async () => {
      ...
      client.innerApiCalls.getNotification =
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNotification(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.advisorynotifications.v1.INotification | null,
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getNotification with closed client', async () => {
      const client =
        new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
  ...
  describe('listNotifications', () => {
    it('invokes listNotifications without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listNotifications as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listNotifications as SinonStub
    ...
    it('invokes listNotifications without error using callback', async () => {
      ...
      client.innerApiCalls.listNotifications =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes listNotificationsStream without error', async () => {
      const client =
        new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      const stream = client.listNotificationsStream(request);
      const promise = new Promise((resolve, reject) => {
        const responses: protos.google.cloud.advisorynotifications.v1.Notification[] =
          [];
        stream.on(
          'data',
          (
            response: protos.google.cloud.advisorynotifications.v1.Notification,
          ) => {
      ...
      assert(
        (client.descriptors.page.listNotifications.createStream as SinonStub)
          .getCall(0)
          .calledWith(client.innerApiCalls.listNotifications, request),
      );
      assert(
        (client.descriptors.page.listNotifications.createStream as SinonStub)
          .getCall(0)
    ...
    it('invokes listNotificationsStream with error', async () => {
      const client =
        new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
    ...
    it('uses async iteration with listNotifications without error', async () => {
      const client =
        new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
      ...
      const responses: protos.google.cloud.advisorynotifications.v1.INotification[] =
        [];
      const iterable = client.listNotificationsAsync(request);
    ...
    it('uses async iteration with listNotifications with error', async () => {
      const client =
        new advisorynotificationsserviceModule.v1.AdvisoryNotificationsServiceClient(
          {
            credentials: { client_email: 'bogus', private_key: 'bogus' },
  ...
  describe('Path templates', () => {
    ...
    describe('organizationLocationNotifications', async () => {
      const fakePath = '/rendered/path/organizationLocationNotifications';
      const expectedParameters = {
        organization: 'organizationValue',
        location: 'locationValue',
      ...
      await client.initialize();
      client.pathTemplates.organizationLocationNotificationsPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.organizationLocationNotificationsPathTemplate.match =
        sinon.stub().returns(expectedParameters);

      it('organizationLocationNotificationsPath', () => {
        const result = client.organizationLocationNotificationsPath(
          'organizationValue',
          'locationValue',
          'notificationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.organizationLocationNotificationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchOrganizationFromOrganizationLocationNotificationsName', () => {
        const result =
          client.matchOrganizationFromOrganizationLocationNotificationsName(
            fakePath,
          );
        assert.strictEqual(result, 'organizationValue');
        assert(
      ...
      it('matchLocationFromOrganizationLocationNotificationsName', () => {
        const result =
          client.matchLocationFromOrganizationLocationNotificationsName(
            fakePath,
          );
        assert.strictEqual(result, 'locationValue');
        assert(
      ...
      it('matchNotificationFromOrganizationLocationNotificationsName', () => {
        const result =
          client.matchNotificationFromOrganizationLocationNotificationsName(
            fakePath,
          );
    ...
    describe('projectLocationNotifications', async () => {
      const fakePath = '/rendered/path/projectLocationNotifications';
      const expectedParameters = {
      ...
      await client.initialize();
      client.pathTemplates.projectLocationNotificationsPathTemplate.render =
        sinon.stub().returns(fakePath);
      client.pathTemplates.projectLocationNotificationsPathTemplate.match =
        sinon.stub().returns(expectedParameters);

      it('projectLocationNotificationsPath', () => {
        const result = client.projectLocationNotificationsPath(
          'projectValue',
          'locationValue',
          'notificationValue',
        );
        ...
        assert(
          (
            client.pathTemplates.projectLocationNotificationsPathTemplate
              .render as SinonStub
          )
            .getCall(-1)
            .calledWith(expectedParameters),
      ...
      it('matchProjectFromProjectLocationNotificationsName', () => {
        const result =
          client.matchProjectFromProjectLocationNotificationsName(fakePath);
      ...
      it('matchLocationFromProjectLocationNotificationsName', () => {
        const result =
          client.matchLocationFromProjectLocationNotificationsName(fakePath);
        assert.strictEqual(result, 'locationValue');
        assert(
          (
            client.pathTemplates.projectLocationNotificationsPathTemplate
      ...
      it('matchNotificationFromProjectLocationNotificationsName', () => {
        const result =
          client.matchNotificationFromProjectLocationNotificationsName(
            fakePath,
          );
        assert.strictEqual(result, 'notificationValue');
        assert(
